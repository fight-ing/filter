//
//  LFSwipedCollectionViewCell.swift
//  LFSwipedCollectionViewCell
...
fileprivate extension UICollectionView {
    ...
    var openingCell: LFSwipedCollectionViewCell? {
        get {
            return objc_getAssociatedObject(self, &AssociatedKeys.currentcell) as? LFSwipedCollectionViewCell
        }
        set {
            if let newValue = newValue {
                objc_setAssociatedObject(
                    ...
                    newValue as LFSwipedCollectionViewCell?,
...
// MARK: -
class LFSwipedCollectionViewCell: UICollectionViewCell,UIGestureRecognizerDelegate {
